CREATE TABLE `sap_business_partner_employee_basic_data`
(
	...
	CONSTRAINT `SAPBusinessPartnerEmployeeBasicData_fk` FOREIGN KEY (`ObjectID`) REFERENCES `sap_business_partner_business_user_collection_data` (`ObjectID`)
) ENGINE = InnoDB
